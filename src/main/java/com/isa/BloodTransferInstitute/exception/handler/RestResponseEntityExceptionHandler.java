...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = { NotFoundException.class, CreateAppointmentException.class, ScheduleException.class, UserHasNoRoleException.class, UsernameNotFoundException.class, ParameterStrategyException.class, CancelException.class, PastAppointmentException.class })
